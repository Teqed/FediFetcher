...
a url that will be pinged when processing has completed. You can use this for 'dead \
man switch' monitoring of your task")
    argparser.add_argument("--on-start", required = False, default=None, help="Provide \
a url that will be pinged when processing is starting. You can use this for 'dead man \
